...
Map<String, String> nextFrase() {
  ...
  return {'': ''}; // Retorna um mapa vazio quando não há mais frases
}
...
class _RecorderScreenState extends State<RecorderScreen>
  ...
  final Record _recorder = Record();/**Abstract classes can't be instantiated.
...
/*There's no constant named 'aacLc' in 'AudioEncoder'.
Try correcting the name to the name of an existing constant, or defining a constant named 'aacLc'.dartundefined_enum_constant
Type: InvalidType*/ 
      setState(() {
        isRecording = true;
